...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Image, TextInput, Dimensions, Animated, ActivityIndicator, Alert, Modal } from 'react-native';
...
export default function GroupDetailScreen({ route, navigation }) {
  ...
  const launchChallengeSheetRef = useRef(null);
  const groupSettingsSheetRef = useRef(null);
  const inviteMembersSheetRef = useRef(null);
  const manageMembersSheetRef = useRef(null);
  const createPostSheetRef = useRef(null);
