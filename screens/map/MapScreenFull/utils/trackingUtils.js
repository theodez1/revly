 ...
 */
export const calculateSpeed = (distanceKm, timeMs) => {
  if (!timeMs || timeMs <= 0) {
    return 0;
  }
 ...
 */
export const filterGPSPoint = (point, lastPoint, options = {}) => {
  const {
 ...
 */
export const detectPause = (speedKmh, threshold = 5, durationMs = 0, minDurationMs = 120000) => {
 ...
 */
export const calculateCalories = (distanceKm, durationHours, weightKg = 70, activityType = 'driving') => {
