...
export default function PaywallModal({ visible, onClose, onActivateDemo, onPurchaseMonthly, onPurchaseYearly, offerDeadlineTs }) {
  ...
  const handlePrimary = () => {
    ...
    else if (onPurchaseYearly) onPurchaseYearly();
    else if (onActivateDemo) onActivateDemo();
  };
...
function PlanCard({ label, price, sub, badge, selected, onPress }) {
  return (
