...
const extractCityFromPayload = (payload) => {
...
const buildSampleIndexes = (totalPoints, maxSamples) => {
...
const shouldLookupCities = (rideData) => {
...
export const geocodingService = {
   ...
   */
  async populateRideCities(rideData, options = {}) {
