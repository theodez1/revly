...
class PostsService {
   ...
   * @returns {Promise<{post: Post | null, error: any}>}
   */
  async createPost(postData: any): Promise<{ post: Post | null; error: any }> {
    try {
   ...
   * @returns {Promise<{post: Post | null, error: any}>}
   */
  async updatePost(id: string, updates: any): Promise<{ post: Post | null; error: any }> {
    try {
      const { data, error } = await supabase
        .from('group_posts')
        .update(updates)
   ...
   * @returns {Promise<{post: Post | null, error: any}>}
   */
  async getPostById(id: string): Promise<{ post: Post | null; error: any }> {
    try {
      const { data, error } = await supabase
        .from('group_posts')
        .select('*')
   ...
   * @returns {Promise<{likes: any[], error: any}>}
   */
  async getPostLikes(postId: string): Promise<{ likes: any[]; error: any }> {
    try {
      const { data, error } = await supabase
        .from('post_likes')
        .select('*')
   ...
   * @returns {Promise<{liked: boolean, error: any}>}
   */
  async toggleLike(postId: string, userId: string): Promise<{ liked: boolean; error: any }> {
    try {
   ...
   * @param {string} postId - ID du post
   * @returns {Promise<{comments: any[], error: any}>}
   */
  async getPostComments(postId: string): Promise<{ comments: any[]; error: any }> {
    try {
      const { data, error } = await supabase
        .from('post_comments')
        .select('*')
   ...
   * @returns {Promise<{comment: any, error: any}>}
   */
  async createComment(commentData: any): Promise<{ comment: any; error: any }> {
    try {
   ...
   * @returns {Promise<{comment: any, error: any}>}
   */
  async updateComment(id: string, updates: any): Promise<{ comment: any; error: any }> {
    try {
      const { data, error } = await supabase
        .from('post_comments')
        .update(updates)
   ...
   * @private
   */
  _formatPost(post: any): Post | null {
    if (!post) return null;
