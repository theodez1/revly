...
class UserRelationshipsService {
     ...
     * @returns {Promise<{following: Array, error: any}>}
     */
     ...
     * @param {string} userId - ID de l'utilisateur
     * @returns {Promise<{followers: Array, error: any}>}
     */
     ...
     * @param {string} userId - ID de l'utilisateur
     * @returns {Promise<{stats: Object, error: any}>}
     */
     ...
     * @param {string} userId - ID de l'utilisateur
     * @returns {Promise<{followingIds: Array<string>, error: any}>}
     */
